  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-black uppercase tracking-tight text-gray-900">BROWN GIRL LIFTS</h1>
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="/subscribe" className="bg-amber-500 text-white px-6 py-2.5 rounded-md font-bold hover:bg-amber-600 transition-colors flex items-center gap-2">
      ...
      <section className="relative">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="relative bg-gray-100">
            ...
            {/* Macro badges below image */}
            <div className="bg-white p-6">
              <div className="grid grid-cols-4 gap-3">
                <div className="text-center">
                  <p className="text-3xl font-black text-gray-900">100g</p>
                  <p className="text-xs font-bold text-gray-600 uppercase tracking-wider">Protein</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-black text-gray-900">1200</p>
                  <p className="text-xs font-bold text-gray-600 uppercase tracking-wider">Calories</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-black text-gray-900">85g</p>
                  <p className="text-xs font-bold text-gray-600 uppercase tracking-wider">Carbs</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl font-black text-gray-900">35g</p>
                  <p className="text-xs font-bold text-gray-600 uppercase tracking-wider">Fats</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-amber-50 flex items-center">
            <div className="px-12 py-16 max-w-xl">
              ...
              <h1 className="text-5xl font-black uppercase leading-tight text-gray-900 mb-6">
                FUEL UP YOUR<br />
                DAY WITH OUR<br />
              ...
              <button className="bg-amber-500 text-white px-8 py-4 rounded-md font-black uppercase text-lg hover:bg-amber-600 transition-all transform hover:scale-105 flex items-center gap-2">
              ...
              <div className="flex items-center gap-6 mt-8">
                ...
                <p className="text-sm text-gray-600">
                  <span className="font-bold text-gray-900">5,000+</span> happy lifters
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="nutrition" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block bg-amber-100 text-amber-700 px-4 py-2 rounded-full text-sm font-bold uppercase mb-4">
              CLEAN EATING
            </span>
            <h2 className="text-4xl font-black uppercase text-gray-900 mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-black text-gray-900">100% Natural</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                ...
                <h3 className="text-3xl font-black text-gray-900 mb-1">100g</h3>
                <p className="text-gray-600 font-bold">High Protein</p>
              ...
              <div className="bg-orange-50 p-6 rounded-xl border border-orange-100">
                ...
                <h3 className="text-3xl font-black text-gray-900 mb-1">1,200</h3>
                <p className="text-gray-600 font-bold">Calories</p>
              ...
              <div className="bg-amber-50 p-6 rounded-xl border border-amber-100">
                ...
                <h3 className="text-3xl font-black text-gray-900 mb-1">85g</h3>
                <p className="text-gray-600 font-bold">Healthy Carbs</p>
              ...
              <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                ...
                <h3 className="text-3xl font-black text-gray-900 mb-1">35g</h3>
                <p className="text-gray-600 font-bold">Good Fats</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-black text-gray-900 text-lg mb-2">High in Richness</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-black text-gray-900 text-lg mb-2">Love in Every Bite</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-black text-gray-900 text-lg mb-2">Un-refined Goodness</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block bg-amber-100 text-amber-700 px-4 py-2 rounded-full text-sm font-black uppercase mb-4">
              SUCCESS STORIES
            </span>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-pink-50 p-8 rounded-2xl">
              ...
              <p className="font-black text-gray-900">FELICIA JOHNSON</p>
            ...
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <p className="font-black text-gray-900">MAYA PATEL</p>
            ...
            <div className="bg-blue-50 p-8 rounded-2xl">
              ...
              <p className="font-black text-gray-900">SARAH CHEN</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h3 className="text-2xl font-black text-gray-900 mb-2">Try It Out</h3>
              ...
              <button className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 py-4 rounded-lg font-black uppercase text-lg transition-colors mb-6">
                Order Single Box
              </button>
            ...
            <div className="bg-amber-500 text-white p-8 rounded-2xl shadow-xl relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-red-500 text-white px-6 py-2 rounded-bl-2xl text-sm font-black">
                SAVE $224/MONTH
              </div>
              <h3 className="text-2xl font-black mb-2">Power Subscription</h3>
              ...
              <button className="w-full bg-white text-amber-600 py-4 rounded-lg font-black uppercase text-lg hover:bg-gray-100 transition-colors mb-6">
                Start Subscription
              </button>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-black uppercase">BROWN GIRL LIFTS</h3>
            </div>
